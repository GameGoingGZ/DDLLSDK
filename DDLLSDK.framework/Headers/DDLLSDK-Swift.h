...
+ (void)loginWithCompletion:(void (^ _Nonnull)(BOOL, UserInfo * _Nullable))completion;
...
/// amazon 参数
@property (nonatomic, copy) NSString * _Nullable amazonAppkey;
@property (nonatomic, copy) NSString * _Nullable amazonVideoID;
@property (nonatomic, copy) NSString * _Nullable amazonInsID;
@property (nonatomic, copy) NSString * _Nullable amazonBannerID;
@end
...
@interface NSObject (SWIFT_EXTENSION(DDLLSDK))
- (NSString * _Nonnull)mirrorOfValue SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)joinPropertyValueWithSeparator:(NSString * _Nonnull)separator SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC7DDLLSDK7Network")
@interface Network : NSObject
/// 启动监听网络变化
+ (void)startListeningWithListener:(void (^ _Nullable)(void))listener;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface Network (SWIFT_EXTENSION(DDLLSDK))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull statusString;)
+ (NSString * _Nonnull)statusString SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL isReachable;)
...
SWIFT_CLASS("_TtC7DDLLSDK8UserInfo")
...
@property (nonatomic, readonly, copy) NSString * _Nonnull inviteCode;
@property (nonatomic, readonly, copy) NSString * _Nonnull channel;
/// 注册时间
@property (nonatomic, readonly) double createTime;
@property (nonatomic, readonly) double createTimeStamp;
/// 注册天数
@property (nonatomic, readonly) NSInteger registerDays;
/// 活跃天数
@property (nonatomic, readonly) NSInteger activeDays;
/// 用户ID
@property (nonatomic, readonly, copy) NSString * _Nonnull uk;
@end
